        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 upper-button-secion px-0">
                    ...
                    <a href="<?php the_field("buy_gift_cards_link", "options"); ?>" class="gift-card-button">
                        <?php the_field("buy_gift_cards", "options"); ?></a>
                            ...
                            <div class="navbar_content">
                                ...
                                <ul id="menu-header-menu" class="nav navbar-nav">
                                    ...
                                    <li id="menu-item-1244"
                                        ...
                                        <a href="#">
                                            <?php the_field("first_nav_text", "options"); ?><i
                                                class="bi bi-chevron-down icon-rotate"></i><i
                                                class="bi bi-chevron-up icon-rotate rotate-up"></i> </a>
                                    ...
                                    <li id="menu-item-1244"
                                        class="menu-item menu-item-type-post_type menu-item-object-page nav-display"><a
                                            href="<?php the_field("buy_gift_cards_link", "options"); ?>">
                                            <?php the_field("buy_gift_cards", "options"); ?></a>
                                    </li>
